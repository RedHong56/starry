...
{
    [SerializeField] private string apiUrl          = "http://127.0.0.1:8000/api/tarot/reading";
    [SerializeField] private string horoscopeApiUrl = "http://127.0.0.1:8000/api/horoscope";
